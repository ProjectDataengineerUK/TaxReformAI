...
│   └── piso_aliquota_ibs.py        # ANEXO_XVI_PISO_ALIQUOTA_PROPRIA — piso_aliquota_ibs(ano), tabela de 49 anos (2029-2077, art. 371); Python puro, ZERO infraestrutura — nenhuma outra feature do projeto tem essa propriedade
