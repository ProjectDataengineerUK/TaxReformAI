...
├── scripts/                  # verificar_busca_hibrida.py, aplicar_migracoes.py, popular_tenants.py, verificar_rls_producao.py, verificar_audit_log_gravado.py, ingerir_tipi.py, verificar_ipi_producao.py, verificar_reducao_producao.py — todos rodam só via workflow, nunca local
├── tests/                    # 433 testes (pytest) — os de schema/RLS/TIPI/Anexos pulam sem DATABASE_URL, rodam de verdade no CI
