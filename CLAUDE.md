...
prova RLS + a leitura de IPI e da Cesta Básica (Anexo I) pelo papel de runtime contra o Cloud SQL
real via `workflow_dispatch` (guarda `MIGRAR`). O bucket GCS e o
...
├── tests/                    # 334 testes (331 passed + 3 skipped local, pytest) — os de schema/RLS/TIPI/Anexo I pulam sem DATABASE_URL, rodam de verdade no CI
